...
function () {
  ...
  Model.prototype.fetch = function () {
    ...
    this.sync.fetch(id).then(function (res) {
      _this.set(res.data); //ko pass qua this.set mà pass gọi trực tiếp set() của attributes vì ko muốn trigger event nào trường hợp này cả.
...
function () {
  ...
  Attributes.prototype.set = function (update) {
    Object.assign(this.data, update); //iterate over update object and take at property one by one or use Object.assign: take all the properties on update, copy paste them to this.data, overwrite properties of this.data
  };
